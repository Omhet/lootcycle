...
export class Preloader extends Scene {
  ...
  preload() {
    ...
    this.load.audio("claw_closes", "sounds/claw_closes.wav");
    this.load.audio("claw_opens", "sounds/claw_opens.wav");
    ...
    this.load.audio("crafting_success", "sounds/crafting_success.mp3");
