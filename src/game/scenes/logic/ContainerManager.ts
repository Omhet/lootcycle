...
export class ContainerManager {
    ...
    private createContainer(): void {
        ...
        const xPos =
            this.scene.cameras.main.width - frame.width / 2 - horizontalMargin;
        const yPos =
            this.scene.cameras.main.height - frame.height / 2 + (38 / 2 + 2); // Assuming groundHeight is 38, replace if needed

        this.containerSprite = this.scene.matter.add.sprite(
            xPos,
            yPos,
            "container",
            undefined,
